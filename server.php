                ...
                <div class="col-sm-12 col-xl-6">
                    ...
                    <?php 
                        if ($server_info[0]['State']['Status'] == "running" || $server_info[0]['State']['Status'] == "starting") {
                            echo '<a href="server-manage.php?server_action=stop&server_name='.$_GET["server_name"].'"><button type="button" style="float: right;" class="btn btn-danger m-2">Stop</button></a>';
                        }
                        else {
                    ...
                    ?>
                        <div class="col-sm-12 col-xl-6">
                            <div class="bg-light rounded h-100 p-4">
                                ...
                                <br>
                                <br>
                                <a href="#" onClick="MyWindow=window.open('server-console.php?server_name=<?php echo htmlspecialchars($_GET["server_name"]); ?>','MyWindow','width=800,height=600'); return false;"><button type="button" class="btn btn-sm btn-secondary m-2">Open Console</button></a>
