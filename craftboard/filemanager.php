    ...
    <div class="container-fluid position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="col-sm-12 col-xl-6">
                    <div class="bg-light rounded h-100 p-4">
                        <form action="filemanager-manage.php?filemanager_action=upload&server_name=<?php echo $_GET['server_name']; ?>&folder_path=<?php echo $_GET['folder_path']; ?>" method="post" enctype="multipart/form-data">
