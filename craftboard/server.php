            ...
            <div class="container-fluid pt-4 px-4">
                <div class="col-sm-12 col-xl-6">
                    <div class="bg-light rounded h-100 p-4">
                        ...
                        <div>
                            <pre><p><?php print_r($server_info[0]['Config']['Env']); ?></p></pre>
                        </div>
                        <br>
                        <br>
                        ...
                        <a href="filemanager.php?server_name=<?php echo $_GET["server_name"]; ?>&folder_path=#"><button type="button" class="btn btn-sm btn-secondary m-2"><?php echo $lang['filemanager']; ?></button></a>
