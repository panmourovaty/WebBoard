                    ...
                    ?>
                        <div class="col-sm-12 col-xl-6">
                            <div class="bg-light rounded h-100 p-6">
                                ...
                                <a href="#" onClick="MyWindow=window.open('server-edit.php?server_name=<?php echo $_GET["server_name"]; ?>','MyWindow','width=800,height=720'); return false;"><button type="button" class="btn btn-sm btn-secondary m-2"><?php echo $lang['edit']; ?></button></a>
