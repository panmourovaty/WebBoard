        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="col-sm-12 col-xl-6">
                    ...
                    <form action="backuptotemplate-step2.php" method="post">
                            <h6 class="mb-4"><?php echo $lang['templatename']; ?>:</h6>
                            <input type="text" class="form-control" id="templatename" name="templatename" required>
                            <br>
                            <input type="hidden" id="backupname" name="backupname" value=<?php echo $_GET["backup_name"]; ?>>
                            <button type="submit" class="btn btn-primary"><?php echo $lang['convert']; ?></button>
                            </form>
                    </div>
                </div>
            </div>
