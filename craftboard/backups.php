        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="backups.php" class="nav-item nav-link active"><i class="fa-solid fa-floppy-disk me-2"></i><?php echo $lang['backups']; ?></a>
                        ...
                        if ($handle = opendir('./files/backups')) {
                            ...
                            while (false !== ($entry = readdir($handle))) {
                                ...
                                if ($entry != "." && $entry != "..") {
                                    ...
                                    echo "$entry";
                                    echo '<a onclick="return confirm(\'' . $lang['areyousure'] . '\')" href="backups-delete.php?backup_name=' . $entry . '"><button type="button" class="btn btn-sm btn-danger m-2"><i class="fa-solid fa-trash"></i></button></a>';
                                    echo '<a href="backuptotemplate.php?backup_name=' . $entry . '"> <button type="button" class="btn btn-sm btn-secondary m-2">' . $lang['converttotemplate'] . '</button></a>';
                                    echo '<a href="/files/backups/' . $entry . '"><button type="button" class="btn btn-sm btn-secondary m-2">' . $lang['download'] . '</button></a>';
                                    echo "<br>";
                                }
                            }
