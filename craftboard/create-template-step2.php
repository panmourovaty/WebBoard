...
<body>
    ...
    <div class="navbar-nav w-100">
        ...
        <a href="create.php" class="nav-item nav-link active"><i class="fa fa-plus me-2"></i>Create New Server</a>
    </div>
    </nav>
    </div> 
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="col-sm-12 col-xl-6">
                    ...
                    <h4 class="mb-4">Creating Server from: <?php echo htmlspecialchars($_GET["template_name"]); ?></h4>
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <form action="create-template-step3.php" method="post">
                            <h6 class="mb-4">Server Name:</h6>
                            <input type="text" class="form-control" id="servername" name="servername" required>
                            <br>
                            <h6 class="mb-4">Server  Port:</h6>
