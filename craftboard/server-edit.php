...
<input style="float: right;" class="btn btn-lg btn-success" type="submit" value="Apply"/><button style="float: right;" class="btn btn-lg btn-destructive" onClick="closeWindow()">Cancel</button>
</form>